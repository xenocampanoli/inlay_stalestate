...
std::string Resin::glomMoldList(std::shared_ptr<Mold> moldPO, const Json::Value& jvoR) {
	std::string		entire;
...
std::string Resin::glomMoldTree(std::shared_ptr<Mold> moldPO, const Json::Value& jvoR) {
